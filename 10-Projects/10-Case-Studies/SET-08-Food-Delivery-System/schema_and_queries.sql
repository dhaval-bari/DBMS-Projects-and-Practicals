...
-- Scenario: Manage restaurants, menus, and orders.
...
-- Tables & Attributes: 
-- 1. Restaurants (RestaurantID, Name, City, Rating) 
-- 2. MenuItems (MenuItemID, RestaurantID, ItemName, Price, Category) 
-- 3. Customers (CustomerID, Name, Phone, Address) 
-- 4. Orders (OrderID, CustomerID, RestaurantID, OrderDate, Status) 
-- 5. DeliveryAgents (AgentID, Name, Phone, VehicleNo) 
...
-- 23 List orders assigned to a specific delivery agent.
